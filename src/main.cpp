...
const string strMessageMagic = "MayanCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MayanCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "This is a mayancoin fork.";
        CTransaction txNew;
        txNew.nTime = 1400123273;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1400123273;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
     //   block.nNonce   = !fTestNet ? 1420335 : 216178;

        block.nNonce   = !fTestNet ? 1825073 : 216178;
        //// debug print
	...
	printf("block.nTime = %u \n", block.nTime);
        ...
        assert(block.hashMerkleRoot == uint256("0x043032bd68cc1ff8efca264cba2cd5c311f7654cc1d8f44f6d8478f97f497cff"));
...
unsigned char pchMessageStart[4] = { 0x71, 0x35, 0x22, 0x05 };
